...
<table class="form-layout">
     <tr>
        ...
        {/if}    
				...
				<tr><td class="label">{ts}{$form.frequency_interval.label}{/ts} </td><td><strong>{$form.is_1recur.html} &nbsp; {$form.frequency_interval.html} &nbsp; {$form.frequency_unit.html}<!--&nbsp; {ts}for{/ts} &nbsp; {$form.installments.html} &nbsp;{$form.installments.label}--></strong></td></tr>
